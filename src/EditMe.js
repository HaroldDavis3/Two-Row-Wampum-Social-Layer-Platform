...
class EditMe extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h2>Your Picture and Banner</h2>
      <p>Pick your picture and Banner!</p>
        <h3>Select your pic</h3>
        ...
        <h3 className="select-territory">Select your banner</h3>
        ...
        <div className="container row">
          <div className="col-lg-12 done">
            <p>
              <Link to={completed?`/council/${username}`:`/me`} 
