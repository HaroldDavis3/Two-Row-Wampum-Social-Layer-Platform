...
export const TURTLE = [
   {
     id: 'turtle',
     name: 'Turtle',
     superpower: 'Owner of the House.'
   }]
   export const TURTLEPG1 = [
      {
        id: 'turtlepg1',
        name: 'Turtlepg1',
        superpower: ''
      ...
      export const BEAR = [
         {
           id: 'bear',
           name: 'Bear',
           superpower: 'The Medicine.'
         }]
         export const BEARPG1 = [
            {
              id: 'bearpg1',
              name: 'Bearpg1',
              superpower: ''
...
export const OTHER_COUNCILS = [
    {
      "app": "https://socialayerdraft.netlify.com/council/angedrol.id.blockstack",
      "ruler": "angedrol.id.blockstack"
    },
    {
       "app": "https://socialayerdraft.netlify.com/council/deziraejohnson.id",
       "ruler": "deziraejohnson.id"
      },
      {
       "app": "https://socialayerdraft.netlify.com/council/haroldthomasdavisiii.id",
       "ruler": "haroldthomasdavisiii.id"
    },
    {
