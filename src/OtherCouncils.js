...
import { appConfig, OTHER_COUNCILS } from './constants'
...
class OtherKingdoms extends Component {
  ...
  resolveKingdoms() {
    ...
    OTHER_COUNCILS.map((kingdom, index) => {
          ...
          {kingdoms.length === 0 ?
            ...
            >
              <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-1">Loading other Councils...</h5>
              </div>
              <p class="mb-1">&nbsp;</p>
            </div>
            :
            ...
            {kingdoms.map((kingdom, index) => {
              ...
              if (kingdom.error) {
                return (
                  ...
                  >
                    <div class="d-flex w-100 justify-content-between">
                      <h5 class="mb-1">{ kingdom.ruler.username }'s council can't be reached</h5>
                    </div>
                ...
                return (
                  <Link
                    className="list-group-item list-group-item-action flex-column align-items-start"
                    to={`/council/${protocol}/${hostname}/${kingdom.ruler.username}`}
                    key={index}
                  >
                    <div class="d-flex w-100 justify-content-between">
                      <h5 class="mb-1">{ kingdom.ruler.username } { animal ? animal.name : '' }</h5>
